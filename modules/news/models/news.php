...
//		}
		...
		function get_category_by_id($category_id)
		{
			if(!$category_id)
				return "";
			$query = " SELECT id,name,name_display,is_comment, alias
	...
	function getNewerNewsList($cid,$created_time)
		...
		function getRelateNewsList($cid)
		{
			...
			$fs_table = FSFactory::getClass('fstable');
			$id = FSInput::get2('id',0,'int');
			$query = ' SELECT id,title,alias, category_id,updated_time ,image,category_alias,created_time,category_name,summary
						FROM '.$this->table_name.'
