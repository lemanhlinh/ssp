...
//        $parts = FSInput::get('contact_parts');
        ...
        $sql = " INSERT INTO 
						" . $this->table_name . " (`email`,fullname,address,telephone,content,edited_time,created_time,published)
						VALUES ('$email','$fullname','$address','$phone','$content','$time','$time','$published')";
        global $db;
        $db->query($sql);
        $id = $db->insert();
        return $id;
