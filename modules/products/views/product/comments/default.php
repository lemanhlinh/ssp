...
<!--				<p class='email'><?php echo $item -> email?></p>-->
	...
	<!-- FORM COMMENT	-->
	<h5 class='comment_form_title' ><i class="fas fa-comments"></i>Gửi bình luận</h5>
	<form action="#" method="post" name="news_comment_add_form" id='news_comment_add_form' >
		<p class='name_email'>
			<input class="form-control" type="text" id="name" value="Họ tên" name="name" size="40"  onfocus="if(this.value=='Họ tên') this.value=''" onblur="if(this.value=='') this.value='Họ tên'"/>
			<input class="form-control" type="text" id="email" value="Email" name="email" size="40" onfocus="if(this.value=='Email') this.value=''" onblur="if(this.value=='') this.value='Email'" />
		</p>
		<p class='captcha'>
			<input class="form-control" type="text" id="txtCaptcha" value="Mã kiểm tra" name="txtCaptcha"  maxlength="10" size="23" onfocus="if(this.value=='Mã kiểm tra') this.value=''" onblur="if(this.value=='') this.value='Mã kiểm tra'" />
		...
		<textarea class="form-control" id="text" cols="84" rows="5" name="text" onfocus="if(this.value=='Nội dung') this.value=''" onblur="if(this.value=='') this.value='Nội dung'">Nội dung</textarea>
