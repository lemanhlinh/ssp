...
//    TemplateHelper::dt_edit_image(FSText:: _('Icon menu'),'image', str_replace('/original/', '/small/', URL_ROOT . @$data->image));
    ?>
...
//    TemplateHelper::dt_edit_text(FSText :: _('Icon'),'icon',@$data -> icon);
