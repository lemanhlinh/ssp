<?php  
global $toolbar;
$toolbar->setTitle(FSText :: _('Comment sản phẩm') );
...
//	CONFIG	
$list_config = array();
$list_config[] = array('title'=>'Bình luận','field'=>'comment','type'=>'text','col_width' => '30%');
$list_config[] = array('title'=>'Tên sản phẩm','field'=>'title','ordering'=> 1, 'type'=>'text','col_width' => '20%');
$list_config[] = array('title'=>'Danh mục sản phẩm','field'=>'category_name','ordering'=> 1, 'type'=>'text','col_width' => '20%');
