...
//    TemplateHelper::dt_edit_text(FSText :: _('Mô tả'),'summary',@$data -> summary,'',100,5,0,'','','col-sm-2','col-sm-8');
//    TemplateHelper::dt_edit_text(FSText :: _('Nội dung'), 'content', @$data->content, '', 650, 450, 1, '', '', 'col-sm-2', 'col-sm-8');

	//$this -> dt_form_end(@$data,1,1);
	$this -> dt_form_end(@$data,1,1,2,'Cấu hình seo','',0,'col-sm-4');
	?>
