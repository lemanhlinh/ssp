...
TemplateHelper::dt_edit_text(FSText :: _('Mô tả'),'description',@$data -> description,'',255,3);
TemplateHelper::dt_checkbox(FSText::_('Hiện tiêu đề'),'is_types',@$data -> is_types,1);
