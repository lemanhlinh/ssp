...
$(document).ready(function() {
        ...
        // var maxHeight = 0;
        //   if ($('.header-logo').height() > maxHeight) { maxHeight = $('.header-logo').height(); }
        // $("header").height(maxHeight);$('.info-footer ul li a').each(function() {    $(this).data('href', $(this).attr('href')).removeAttr('href');});
        $("#cmbIdioma").select2({
                templateResult: function (idioma) {
                        var $span = $("<span><img src='"+idioma.title+"' align='bottom'/> " + idioma.text + "</span>");
                        return $span;
                },
