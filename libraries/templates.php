...
//
//var_dump($data); die;
//echo $data[0]->category_name.$data[0]->name; die;
...
<meta property="og:url"  content="http://<?php echo $_SERVER['HTTP_HOST'].$_SERVER['SCRIPT_NAME']; ?>" />
...
<link rel="canonical" href="http://<?php echo $_SERVER['HTTP_HOST'].$_SERVER['SCRIPT_NAME']; ?>" />
<link rel="alternate" media="handheld" href="http://<?php echo $_SERVER['HTTP_HOST'].$_SERVER['SCRIPT_NAME']; ?>" />
<link rel="alternate" href="http://<?php echo $_SERVER['HTTP_HOST'].$_SERVER['SCRIPT_NAME']; ?>" hreflang="x" />
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $config ['site_name']?> Feed" href="<?php echo URL_ROOT;	?>rss.xml" />
 <link href="https://fonts.googleapis.com/css?family=Roboto:300,300i,400,700,700i&display=swap&subset=vietnamese" rel="stylesheet">
<?php
global $config;
if(isset($this->array_meta)){
