...
//	  imagettftext($image, 14, 4, 15, 25, $grey, 'SerpentisBlack.ttf', $string);  
	...
	$y1 = rand(22, 28);
	imagettftext($image, 15,  rand(-30, 30), 12, $y1, $black, 'Verdana.ttf', substr($string,  0, 1));
	$y2 = rand(15, 20);
	imagettftext ($image, 15, rand(0, 30), rand(30, 40), $y2, $line2,'trebuc.ttf', substr($string,  1, 1));
	$y3 = rand(22, 28);
	ImageTTFText ($image, 15, rand(-20, 0), rand(40, 50), $y3, $black,'trebuc.ttf', substr($string,  2, 1));
	$y4 = rand(15, 20);
	ImageTTFText ($image, 15, rand(0, 30), rand(60, 70), $y4, $black, 'Verdana.ttf', substr($string,  3, 1));
//	$x = rand(0, 50);
//	$y = rand(0, 50);
